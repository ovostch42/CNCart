...
MOSIKStep::MOSIKStep(byte actM1, byte actM2, byte dirM1, byte dirM2, byte servopin, int Dbase, int mindelay, int maxdelay, float diam){
  _actM1 = actM1;
  _actM2 = actM2;
  _dirM1 = dirM1;
  _dirM2 = dirM2;
